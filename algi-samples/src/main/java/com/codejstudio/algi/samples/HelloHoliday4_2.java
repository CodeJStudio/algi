...
/**
 * sample: calculate: 9+1=? (via ActionableElement)
 * 
...
public class HelloHoliday4_2 {
	...
	public static void main(String[] args) throws Exception {
		...
		doXmlMarshal();
//		HelloAction.doXmlUnmarshal(HelloHoliday4_2.class.getSimpleName());
	}
...
//		EquivalenceRelation eqr40 = 
		...
		// HelloHoliday4_2.java
		//ActionableElement
		IActionable afl4_2_1 = new ActionFlow(adf40);
		InputParameter[] ipa4_2_1 = InputParameter.informationInstances("a", c009, "b", c001);//9, 1
		Object[] aflOutputArray4_2_1 = afl4_2_1.execute(ipa4_2_1);
		System.out.println();
		System.out.println("ActionableElement4_2_1.execute: " 
				+ ((aflOutputArray4_2_1 == null) ? null : Arrays.asList((Object[]) aflOutputArray4_2_1)));
