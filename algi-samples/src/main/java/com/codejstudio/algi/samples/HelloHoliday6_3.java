...
/**
 * sample: calculate: 16+7=? (via SimpleThinkAction & SimpleSentenceThinkAction)
 * 
...
public class HelloHoliday6_3 {
	...
	public static void main(String[] args) throws Exception {
		...
		doXmlMarshal();
//		HelloAction.doXmlUnmarshal(HelloHoliday6_3.class.getSimpleName());
	}
...
//		BaseRelation br6 = 
				new BaseRelation(dc3, dscdf61);



		// HelloHoliday6_3.java
		//SimpleThinkAction
		Action sta6_3_1 = new SimpleThinkAction("<st(>" + dc3.getId() + "<)>");
		InputParameter[] ipa6_3_1 = InputParameter.informationInstances("a", c016, "b", c007);//16, 7
		Object[] staOutputArray6_3_1 = sta6_3_1.execute(ipa6_3_1);
		System.out.println();
		System.out.println("SimpleThinkAction6_3_1.execute: " 
				+ ((staOutputArray6_3_1 == null) ? null : Arrays.asList((Object[]) staOutputArray6_3_1)));

		//SimpleSentenceThinkAction
		Action ssta6_3_1 = new SimpleSentenceThinkAction("<sst(>16,加,7<)>");
		Object[] sstaOutputArray6_3_1 = ssta6_3_1.execute();
		System.out.println();
		System.out.println("SimpleSentenceThinkAction6_3_1.execute: " 
				+ ((sstaOutputArray6_3_1 == null) ? null : Arrays.asList((Object[]) sstaOutputArray6_3_1)));

		Action ssta6_3_2 = new SimpleSentenceThinkAction("<sst(>16,plus,7<)>");
		Object[] sstaOutputArray6_3_2 = ssta6_3_2.execute();
		System.out.println();
		System.out.println("SimpleSentenceThinkAction6_3_2.execute: " 
				+ ((sstaOutputArray6_3_2 == null) ? null : Arrays.asList((Object[]) sstaOutputArray6_3_2)));
