...
/**
 * sample: calculate: XXXXX+XXXX=? (via ActionableElement)
 * 
...
public class HelloHoliday7_2 {
	...
	public static void main(String[] args) throws Exception {
		...
		doXmlMarshal();
//		HelloAction.doXmlUnmarshal(HelloHoliday7_2.class.getSimpleName());
	}
...
//		EquivalenceRelation eqr70 = 
		...
		// HelloHoliday7_2.java
		//ActionableElement
		IActionable afl7_2_1 = new ActionFlow(adf70);
		InputParameter[] ipa7_2_1 = InputParameter.generateInstances("a", "6454659", "b", "123457125");
		Object[] aflOutputArray7_2_1 = afl7_2_1.execute(ipa7_2_1);
		System.out.println();
		System.out.println("ActionableElement7_2_1.execute: " 
				+ ((aflOutputArray7_2_1 == null) ? null : Arrays.asList((Object[]) aflOutputArray7_2_1)));
