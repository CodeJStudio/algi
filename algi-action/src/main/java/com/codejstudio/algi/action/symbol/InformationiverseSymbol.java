...
import com.codejstudio.algi.action.symbolElement.InformationiverseSymbolElement;
 ...
 * @since   algi_v1.0.0
 */
public class InformationiverseSymbol extends AbstractMultiContentSymbol {

	/* constants */

	private static final long serialVersionUID = -2966601219507388032L;

	public static final String SYMBOL = "iu";//Informatio(U)niverse

	public static final Class<? extends ISymbolElement> SYMBOL_ELEMENT_CLAZZ 
			= InformationiverseSymbolElement.class;
	private static final InformationiverseSymbol SYMBOL_INSTANCE = new InformationiverseSymbol();
	...
	private static final Class<?>[] TYPE_ARRAY = {String.class, LogicValue.class};


	/* constructors */

	private InformationiverseSymbol() {
		super();
	}
	...
	static {
		...
		SymbolConstant.registerSymbolClassForInit(InformationiverseSymbol.class);
	}


	/* getters & setters */

	public static InformationiverseSymbol getInstance() {
