...
import com.codejstudio.algi.action.symbolElement.GetElementSymbolElement;
 ...
 * @since   algi_v1.0.0
 */
public class GetElementSymbol extends AbstractMultiContentSymbol {

	/* constants */

	private static final long serialVersionUID = 8365568766602340852L;

	public static final String SYMBOL = "ge";//Get Element of a List/Array

	public static final Class<? extends ISymbolElement> SYMBOL_ELEMENT_CLAZZ = GetElementSymbolElement.class;
	private static final GetElementSymbol SYMBOL_INSTANCE = new GetElementSymbol();
	...
	private static final Class<?>[] TYPE_ARRAY = {Object.class, Integer.class};


	/* constructors */

	private GetElementSymbol() {
		super();
	}
	...
	static {
		...
		SymbolConstant.registerSymbolClassForInit(GetElementSymbol.class);
	}


	/* getters & setters */

	public static GetElementSymbol getInstance() {
